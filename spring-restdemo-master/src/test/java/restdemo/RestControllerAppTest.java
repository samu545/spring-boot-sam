...
import restdemo.controller.RestControllerApp;
import restdemo.objects.RestObject;
import restdemo.service.IDataService;


@RunWith(MockitoJUnitRunner.class)
public class RestControllerAppTest {
	@Mock
	...
	public void setUp() {
		...
		mockMvc = MockMvcBuilders.standaloneSetup(new RestControllerApp(service)).build();
	}
